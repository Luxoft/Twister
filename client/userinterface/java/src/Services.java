...
public class Services extends JPanel{
    ...
    public Services(){
        ...
        try{
            String result = Repository.getRPCClient().execute("serviceManagerCommand",
    ...
    private void addNewServices(String name){
        try{
            ...
            result = Repository.getRPCClient().execute("serviceManagerCommand",
    ...
    class MyPanel extends JPanel{
        ...
        public void configWindow(){
            ...
            try{
                conf.setText(Repository.getRPCClient().execute("serviceManagerCommand",
