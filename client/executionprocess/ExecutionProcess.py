...
if __name__=='__main__':
    ...
    #
    # python -B -u ExecutionProcess.py -u user -e Windows-EP -s 127.0.0.1:8000
    #

    if len(sys.argv) < 3:
        print('*ERROR* EP must start with 3 parameters!')
        print(' usage : python -B ExecutionProcess.py -u User -e Ep_Name -s Host:Port')
        exit(1)
