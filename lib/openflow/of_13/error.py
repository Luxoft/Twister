...
class role_request_failed_error_msg(ofp_error_msg):
    """
    Wrapper class for role_request_failed error message class
    ...
    def __init__(self):
        ...
        self.header = ofp_header()
        self.header.type = OFPT_ERROR
        self.type = OFPET_ROLE_REQUEST_FAILED
        self.data = ""
    ...
    def show(self, prefix=''):
        outstr = prefix + "role_request_failed_error_msg\m"
        outstr += self.header.show(prefix + '  ')
        outstr += ofp_error_msg.show(self, prefix + '  ')
        outstr += prefix + "data is of length " + str(len(self.data)) + '\n'
        ##@todo Consider trying to parse the string
...
class meter_mod_failed_error_msg(ofp_error_msg):
    """
    Wrapper class for meter_mod_failed error message class
    ...
    def __init__(self):
        ...
        self.header = ofp_header()
        self.header.type = OFPT_ERROR
        self.type = OFPET_METER_MOD_FAILED
        self.data = ""
    ...
    def show(self, prefix=''):
        outstr = prefix + "meter_mod_failed_error_msg\m"
        outstr += self.header.show(prefix + '  ')
        outstr += ofp_error_msg.show(self, prefix + '  ')
        outstr += prefix + "data is of length " + str(len(self.data)) + '\n'
        ##@todo Consider trying to parse the string
...
class table_features_failed_error_msg(ofp_error_msg):
    """
    Wrapper class for table_features_failed error message class
    ...
    def __init__(self):
        ...
        self.header = ofp_header()
        self.header.type = OFPT_ERROR
        self.type = OFPET_TABLE_FEATURES_FAILED
        self.data = ""
    ...
    def show(self, prefix=''):
        outstr = prefix + "table_features_failed_error_msg\m"
        outstr += self.header.show(prefix + '  ')
        outstr += ofp_error_msg.show(self, prefix + '  ')
        outstr += prefix + "data is of length " + str(len(self.data)) + '\n'
        ##@todo Consider trying to parse the string
...
class experimenter_error_msg(ofp_error_msg):
    """
    Wrapper class for experimenter error message class
    ...
    def show(self, prefix=''):
        outstr = prefix + "experimenter_error_msg\m"
        outstr += self.header.show(prefix + '  ')
        outstr += ofp_error_msg.show(self, prefix + '  ')
        outstr += prefix + "data is of length " + str(len(self.data)) + '\n'
        ##@todo Consider trying to parse the string
