...
class SetVlan(SimpleDataPlane):
    """
    Set VID to tcp packet
    """
    def runTest(self):
        self.logger.info("Running SetVlan test")
	...
	self.logger.info("Generate and send flow_mod with action Set VID to 40")
        ...
        field_2b_set = match.vlan_vid(40)
	...
	self.logger.info("Verify incoming packet have VID 40")
        self.assertEqual(p.vlan, 40, "Packet VID is not 40")
