"""
<title>PushMultiple</title>
<description>
    Push VLAN,MPLS,PBB tags to packet
...
class PushMultiple(SimpleDataPlane):
    """
    Push VLAN,MPLS,PBB tags to packet
    """
    def runTest(self):
        self.logger.info("Running PushMultiple test")
	...
	vid_act.ethertype = 0x88e7
        ...
        self.assertEqual(str(p.type), "35047", "First tag should be PBB")
