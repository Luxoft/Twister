"""
<title>ChangeDSTarp</title>
<description>
    Change Ethernet dst mac address
...
class ChangeDSTarp(SimpleDataPlane):
    """
    Change Ethernet dst mac address
    """
    def runTest(self):
        self.logger.info("Running ChangeDSTarp test")
        ...
        self.assertEqual(str(p.dst), "00:11:22:33:44:12", "DST ARP set do not match")
