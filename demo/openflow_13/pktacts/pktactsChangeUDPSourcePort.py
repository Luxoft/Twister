"""
<title>ChangeUDPSourcePort</title>
<description>
    Change source port of packet
...
class ChangeUDPSourcePort(SimpleDataPlane):
    """
    Change source port of packet
    """
    def runTest(self):
        self.logger.info("Running ChangeUDPSourcePort test")
        ...
        field_2b_set = match.udp_src(888)
        ...
        self.assertEqual(str(p.payload.sport), "888", "Source set do not match")

    
tc = ChangeUDPSourcePort()
_RESULT = tc.run()
