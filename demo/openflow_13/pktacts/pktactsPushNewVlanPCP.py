...
class PushNewVlanPCP(SimpleDataPlane):
    """
    Set VID to tcp packet
    """
    def runTest(self):
        self.logger.info("Running PushNewVlanPCP test")
        ...
        self.assertEqual(str(p.vlan), "1536", "VID set do not match")
