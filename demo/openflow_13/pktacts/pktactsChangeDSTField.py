"""
<title>ChangeDSTField</title>
<description>
    Change destination of a packet from 192.168.0.2 to 10.0.0.2
...
class ChangeDSTField(SimpleDataPlane):
    """
    Change destination of a packet from 192.168.0.2 to 10.0.0.2
    """
    def runTest(self):
        self.logger.info("Running ChangeDSTField test")
        ...
        self.assertEqual(p.payload.dst, "10.0.0.2", "Destination set do not match")
