"""
<title>SetDecTTL</title>
<description>
    Set decrement TTL to packet
...
class SetDecTTL(SimpleDataPlane):
    """
    Set decrement TTL to packet
    """
    def runTest(self):
        self.logger.info("Running SetDecTTL test")
        ...
        self.assertEqual(str(p.ttl), "63", "TTL dec do not match")
