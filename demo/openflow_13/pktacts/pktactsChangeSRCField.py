"""
<title>ChangeSRCField</title>
<description>
    Change source of a packet from 192.168.0.1 to 10.0.0.1
...
class ChangeSRCField(SimpleDataPlane):
    """
    Change source of a packet from 192.168.0.1 to 10.0.0.1
    """
    def runTest(self):
        self.logger.info("Running ChangeSRCField test")
        ...
        field_2b_set = match.ipv4_src(ipaddr.IPv4Address('10.0.0.1'))
        ...
        self.assertEqual(p.payload.src, "10.0.0.1", "Source set do not match")
