"""
<title>ChangeSRCarp</title>
<description>
    Change Ethernet src mac address
...
class ChangeSRCarp(SimpleDataPlane):
    """
    Change Ethernet src mac address
    """
    def runTest(self):
        self.logger.info("Running ChangeSRCarp test")
        ...
        self.assertEqual(str(p.src), "00:11:22:33:44:11", "SRC ARP set do not match")
