...
class ChangeIPecn(SimpleDataPlane):
    """
    Change IP ECN
    """
    def runTest(self):
        self.logger.info("Running ChangeIPecn test")
        ...
        self.assertEqual(str(p.payload.tos), "5", "ECN set do not match")
