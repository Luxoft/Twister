"""
<title>SetMPLSbox</title>
<description>
    Set MPLS bos to tcp packet
</description>
"""
...
class SetMPLSbos(SimpleDataPlane):
    """
    Set mpls bos to tcp packet
    """
    def runTest(self):
        self.logger.info("Running SetMPLSbos test")
	...
	self.logger.info("Generate and send flow_mod with action Set MPLS bos to 0")
	...
	self.logger.info("Verify incoming packet have mpls bos 0")
        self.assertEqual(p.s, 0, "Packet mpls bos is not 0")
