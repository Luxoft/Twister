...
class ChangeUDPDstPort(SimpleDataPlane):
    """
    Change dst port of packet
    """
    def runTest(self):
        self.logger.info("Running ChangeUDPDstPort test")
        ...
        field_2b_set = match.udp_dst(888)
        ...
        self.assertEqual(str(p.payload.dport), "888", "Source set do not match")
