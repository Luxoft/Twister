...
class SetNewTTLipv6(SimpleDataPlane):
    """
    Set new TTL to ipv6 packet
    """
    def runTest(self):
        self.logger.info("Running SetNewTTLipv6 test")
	...
	self.logger.info("Verify incoming packet have hop_count set to 1")
	self.assertEqual(p.hlim, 1, "Incoming packet do not have hlim 1")
