...
class ChangeETHtype(SimpleDataPlane):
    """
    Change Ethernet type
    """
    def runTest(self):
        self.logger.info("Running ChangeETHtype test")
	...
	self.logger.info("Generate and send flow_mod with action SET_ETH_TYPE to 0x8847")
        ...
        field_2b_set = match.eth_type(0x8847)
        ...
        self.assertEqual(p.type, 0x8847, "Ethertype set do not match")
