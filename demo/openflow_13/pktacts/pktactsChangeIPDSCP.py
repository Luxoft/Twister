...
class ChangeIPDSCP(SimpleDataPlane):
    """
    Change IP DSCP
    """
    def runTest(self):
        self.logger.info("Running ChangeIPDSCP")
        ...
        self.assertEqual(str(p.payload.tos), "9", "DSCP set do not match")
