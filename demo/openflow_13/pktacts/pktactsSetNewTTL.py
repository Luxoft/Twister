"""
<title>SetNewTTL</title>
<description>
    Set new TTL to packet
...
class SetNewTTL(SimpleDataPlane):
    """
    Set new TTL to packet
    """
    def runTest(self):
        self.logger.info("Running SetNewTTL test")
        ...
        self.assertEqual(str(p.ttl), "1", "TTL set do not match")
