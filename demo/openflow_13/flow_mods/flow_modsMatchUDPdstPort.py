...
class MatchUDPdstPort(SimpleDataPlane):
    """
    Verify flow_mod matches on UDP dst port
    """
    def runTest(self):
        self.logger.info("Running MatchUDPdstPort test")
        self.logger.info("Verify flow_mod matches on UDP dst port")
        ...
        pkt2 = testutils.simple_udp_packet(tcp_dport=8123)
