"""
<title>MatchTCPsrcPort</title>
<description>
    Verify flow_mod matches on TCP src port
...
class MatchTCPsrcPort(SimpleDataPlane):
    """
    Verify flow_mod matches on TCP src port
    """
    def runTest(self):
        self.logger.info("Running MatchTCPsrcPort test")
        self.logger.info("Verify flow_mod matches on TCP src port")
        ...
        pkt2 = testutils.simple_tcp_packet(tcp_sport=8123)
