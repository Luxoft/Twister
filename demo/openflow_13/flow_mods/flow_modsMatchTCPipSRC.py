"""
<title>MatchTCPipSRC</title>
<description>
    Verify flow_mod matches on TCP IP src
...
class MatchTCPipSRC(SimpleDataPlane):
    """
    Verify flow_mod matches on TCP IP src
    """
    def runTest(self):
        self.logger.info("Running MatchTCPipSRC test")
        self.logger.info("Verify flow_Mod matches on IP src")
        ...
        dstmatch = match.ipv4_src(ipaddr.IPv4Address('192.168.0.1'))
        ...
        pkt2 = testutils.simple_tcp_packet(ip_src='10.0.0.2')
