"""
<title>FlowExpireHard</title>
<description>
    Verify flow expire messages are properly generated.

    Generate a packet
    Generate and install a matching flow with hard timeout = 1 sec
...
class FlowExpireHard(SimpleDataPlane):
    """
    Verify flow expire messages are properly generated.
    ...
    def runTest(self):
        ...
        self.logger.info("Running FlowExpireHard test")
        self.logger.info("Insert flow_mod with hard_timeout=1, wait to expire")
        test_timeout = 60
