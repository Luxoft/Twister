"""
<title>SlaveRoleFlowmod</title>
<description>A slave controller should not be able to send Flowmod messages
</description>
"""
...
class SlaveRoleFlowmod(MultipleController):
    ...
    def runTest(self):
        ...
        self.logger.info("Running slave controller packetout test ")
        ...
        self.logger.info("Sending flowmod request")
        #Try sending PacketOut message, expect error
