"""
<title>IPv6SetFieldSRC</title>
<description>
    Set SRC field on IPv6 packet
...
class IPv6SetFieldSRC(SimpleDataPlane):
    """
    Set SRC field on IPv6 packet
    """

    def runTest(self):
        self.logger.info("Running IPv6SetFieldSRC test")
        self.logger.info("Insert flow_mod with action to change the SRC field")
        ...
        ipv6_src = match.ipv6_dst(ipaddr.IPv6Address('fe80::2420:52ff:fe8f:5189'))
        request.match_fields.tlvs.append(port)
        request.match_fields.tlvs.append(eth_type)
        request.match_fields.tlvs.append(ipv6_src)
        field_2b_set = match.ipv6_src(ipaddr.IPv6Address('fe80::2420:52ff:fe8f:DDDD'))
...
#       TODO: insert action set field properly
        ...
        #Send packet
        pkt = testutils.simple_ipv6_packet(ip_dst='fe80::2420:52ff:fe8f:5189',ip_src='fe80::2420:52ff:fe8f:5190')
        self.logger.info("Sending IPv6 packet to " + str(ing_port))
        self.dataplane.send(ing_port, str(pkt))
        #Receive packet
        exp_pkt = testutils.simple_ipv6_packet(ip_src='fe80::2420:52ff:fe8f:DDDD',ip_dst='fe80::2420:52ff:fe8f:5189')
