"""
<title>NoForward</title>
<description>
    Generate port_mod OFPPC_NO_FWD message and send
...
class NoForward(SimpleDataPlane):
    """
    Generate port_mod OFPPC_NO_FWD message and send
    """
    def runTest(self):
        ...
        logMsg('logDebug',"Response from switch:")
        logMsg('logDebug',response.show())
        self.assertEqual(ofp.OFPPC_NO_FWD, response.ports[0].config, "Config do not match OFPPC_NO_FWD")
