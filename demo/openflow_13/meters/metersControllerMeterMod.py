"""
<title>ControllerMeterMod</title>
<description>
    Insert a simple meter_mod for controller port and verify it is supported
...
class ControllerMeterMod(SimpleProtocol):
    """
    Insert a simple meter_mod for controller port and verify it is supported
    """
    def runTest(self):
        self.logger.info("Running ControllerMeterMod test")
        ...
        msg.meter_id = ofp.OFPM_CONTROLLER
