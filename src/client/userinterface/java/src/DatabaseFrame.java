...
public class DatabaseFrame extends JFrame{
    ...
    public DatabaseFrame(DefPanel userDefinition){
        ...
        Repository.window.setEnabled(false);
        addWindowListener(new WindowAdapter(){
            public void windowClosing(WindowEvent e){
                Repository.window.setEnabled(true);
                dispose();}});
        initComponents();
        setAlwaysOnTop(true);
    ...
    public void executeQuery(){
        ...
        try{String result = (String)Repository.getRPCClient().execute("runDBSelect",new Object[]{Repository.getUser(),query});
