...
public class Dut extends JPanel {
	...
	JTextField propvalue, propvalue2, tname0, tname, tname2, tname3, tname4,
			propname, propvalue3, propname2, propname3, tid0, tid, tvendor,
			ttype, tfamily, tmodel;
	...
	private void initComponents() {
		...
		add3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent ev) {
				if (temp3 != null && !propname3.getText().equals("")
					...
					temp3.properties.add(new String[] { propname3.getText(),
							propvalue3.getText() });
					propname3.setText("");
					propvalue3.setText("");
		...
		tname3.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent ev) {
				if (temp3 != null) {
					...
					((DefaultTreeModel) explorer.tree.getModel())
							.nodeChanged(nodetemp3);
				}
			}
		});
		...
		tname4.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent ev) {
				if (temp3 != null) {
					...
					((DefaultMutableTreeNode) nodetemp3.getChildAt(0))
							.setUserObject("Port type: " + tname4.getText());
					((DefaultTreeModel) explorer.tree.getModel())
							.nodeChanged(nodetemp3.getChildAt(0));
				}
			}
		});
		...
		add2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent ev) {
				if (temp2 != null && !propname2.getText().equals("")
						&& !propvalue2.getText().equals("")
						&& !checkForNumber(propname2.getText().charAt(0))) {
					temp2.properties.add(new String[] { propname2.getText(),
							propvalue2.getText() });
					propname2.setText("");
					propvalue2.setText("");
		...
		tname2.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent ev) {
				if (temp2 != null) {
					...
					((DefaultTreeModel) explorer.tree.getModel())
							.nodeChanged(nodetemp2);
					((DefaultMutableTreeNode) nodetemp2.getChildAt(0))
							.setUserObject("Module Type: " + tname2.getText());
					((DefaultTreeModel) explorer.tree.getModel())
							.nodeChanged(nodetemp2.getChildAt(0));
				}
			}
		});
		...
		tid0.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent ev) {
				if (temp0 != null) {
					...
					((DefaultMutableTreeNode) nodetemp0.getChildAt(0))
							.setUserObject("Id: " + tid0.getText());
					((DefaultTreeModel) explorer.tree.getModel())
							.nodeChanged(nodetemp0.getChildAt(0));
				}
			}
		});
		...
		tdescription0.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent ev) {
				if (temp0 != null) {
					...
					((DefaultMutableTreeNode) nodetemp0.getChildAt(1))
							.setUserObject("Description: "
									+ tdescription0.getText());
					((DefaultTreeModel) explorer.tree.getModel())
							.nodeChanged(nodetemp0.getChildAt(1));
				}
			}
		});
		...
		add.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent ev) {
				if (temp != null && !propname.getText().equals("")
					...
					temp.properties.add(new String[] { propname.getText(),
							propvalue.getText() });
					propname.setText("");
					propvalue.setText("");
		...
		tid.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent ev) {
				if (temp != null) {
					...
					((DefaultMutableTreeNode) nodetemp1.getChildAt(0))
							.setUserObject("Id: " + tid.getText());
					((DefaultTreeModel) explorer.tree.getModel())
							.nodeChanged(nodetemp1.getChildAt(0));
				}
			}
		});
		...
		tvendor.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent ev) {
				if (temp != null) {
					...
					((DefaultMutableTreeNode) nodetemp1.getChildAt(2))
							.setUserObject("Vendor: " + tvendor.getText());
					((DefaultTreeModel) explorer.tree.getModel())
							.nodeChanged(nodetemp1.getChildAt(2));
				}
			}
		});
		...
		ttype.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent ev) {
				if (temp != null) {
					temp.setType(ttype.getText());
					((DefaultMutableTreeNode) nodetemp1.getChildAt(3))
							.setUserObject("Type: " + ttype.getText());
					((DefaultTreeModel) explorer.tree.getModel())
							.nodeChanged(nodetemp1.getChildAt(3));
				}
			}
		});
		...
		tfamily.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent ev) {
				if (temp != null) {
					...
					((DefaultMutableTreeNode) nodetemp1.getChildAt(4))
							.setUserObject("Family: " + tfamily.getText());
					((DefaultTreeModel) explorer.tree.getModel())
							.nodeChanged(nodetemp1.getChildAt(4));
				}
			}
		});
		...
		tmodel.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent ev) {
				if (temp != null) {
					...
					((DefaultMutableTreeNode) nodetemp1.getChildAt(5))
							.setUserObject("Model: " + tmodel.getText());
					((DefaultTreeModel) explorer.tree.getModel())
							.nodeChanged(nodetemp1.getChildAt(5));
				}
			}
		});
		...
		tdescription.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent ev) {
				if (temp != null) {
					...
					((DefaultMutableTreeNode) nodetemp1.getChildAt(1))
							.setUserObject("Description: "
									+ tdescription.getText());
					((DefaultTreeModel) explorer.tree.getModel())
							.nodeChanged(nodetemp1.getChildAt(1));
				}
			}
		});
		p2.add(tdescription);
		try {
			Repository.c.cd(Repository.REMOTEHARDWARECONFIGDIRECTORY);
		} catch (Exception e) {
		...
		try {
			System.out.println(Repository.c.pwd());
		} catch (Exception e) {
		}
		...
		PropertiesPanelLayout
				.setHorizontalGroup(PropertiesPanelLayout
						...
						.addGroup(
								PropertiesPanelLayout.createParallelGroup(
										...
										.addComponent(jScrollPane4,
												...
												Short.MAX_VALUE)));
		PropertiesPanelLayout.setVerticalGroup(PropertiesPanelLayout
				.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGap(0, 121, Short.MAX_VALUE)
				.addGroup(
						PropertiesPanelLayout.createParallelGroup(
								GroupLayout.Alignment.LEADING).addComponent(
								jScrollPane4, GroupLayout.DEFAULT_SIZE, 121,
								Short.MAX_VALUE)));
						...
						.addGroup(
								MainPanelLayout
										...
										.addComponent(SettingsPanel,
												...
												GroupLayout.DEFAULT_SIZE,
												Short.MAX_VALUE)
										.addComponent(GeneralButtonsPanel,
												GroupLayout.DEFAULT_SIZE,
												GroupLayout.DEFAULT_SIZE,
												Short.MAX_VALUE))
						.addContainerGap()));
	...
	public void save() {
		...
		if (name != null) {
			try {
				...
				for (int i = 0; i < ((TreeNode) explorer.tree.getModel()
						.getRoot()).getChildCount(); i++) {
					Element em = document.createElement("testbed");
					root.appendChild(em);
					traverseTree(
							((TreeNode) explorer.tree.getModel().getRoot())
									.getChildAt(i),
							em, document);
				}
				File file = new File(Repository.temp + Repository.getBar()
						+ "Twister" + Repository.getBar() + "HardwareConfig"
				...
				try {
					...
					try {
						Repository.c
								.cd(Repository.REMOTEHARDWARECONFIGDIRECTORY);
					} catch (Exception e) {
						System.out.println("could not get "
								+ Repository.REMOTEHARDWARECONFIGDIRECTORY);
					}
	...
	public void generate() {
		try {
			String status = "";
			try {
				status = (String) Repository.frame.mainpanel.p2.client.execute(
			...
			if (!status.equals("running")) {
				...
				try {
					...
					e.printStackTrace();
					System.out.println("Could not save in file : "
							+ file.getCanonicalPath() + " and send to "
							+ Repository.REMOTEHARDWARECONFIGDIRECTORY);
				}
			} else {
	...
	private void load(String file) {
		try {
			...
			if (file == null) {
				...
				Vector<LsEntry> files = Repository.c
						.ls(Repository.REMOTEHARDWARECONFIGDIRECTORY);
				int size = files.size();
				...
				config = (String) JOptionPane.showInputDialog(null,
						"Please select a DUT file", "Config", 1, null, configs,
						"Configs");
			} else {
				config = file;
			}
			if (config != null) {
				...
				try {
					...
					System.out.println("Please check the hwconfig file "
				...
				if (doc != null) {
					...
					if (childsnr > 0) {
						while (((DefaultMutableTreeNode) explorer.tree
								.getModel().getRoot()).getChildCount() > 0) {
							((DefaultTreeModel) explorer.tree.getModel())
									.removeNodeFromParent((DefaultMutableTreeNode) (((DefaultMutableTreeNode) explorer.tree
											.getModel().getRoot())
											.getChildAt(0)));
						}
						for (int j = 0; j < childsnr; j++) {
							...
							try {
								t.setName(((Element) tbnode)
										.getElementsByTagName("testbedname")
										.item(0).getChildNodes().item(0)
										.getNodeValue());
							} catch (Exception e) {
								t.setName("");
							}
							DefaultMutableTreeNode child0 = new DefaultMutableTreeNode(
									t);
							((DefaultMutableTreeNode) (explorer.tree.getModel()
									.getRoot())).add(child0);
							try {
								t.setID(((Element) tbnode)
										.getElementsByTagName("testbedid")
										.item(0).getChildNodes().item(0)
										.getNodeValue());
							} catch (Exception e) {
								t.setID("");
							}
							DefaultMutableTreeNode child03 = new DefaultMutableTreeNode(
									"Id: " + t.id, false);
							child0.add(child03);
							try {
								t.setDescription(((Element) tbnode)
										.getElementsByTagName("testbeddesc")
										.item(0).getChildNodes().item(0)
										.getNodeValue());
							} catch (Exception e) {
								t.setDescription("");
							}
							DefaultMutableTreeNode child02 = new DefaultMutableTreeNode(
									"Description: " + t.description, false);
							child0.add(child02);
							if (((Element) tbnode).getElementsByTagName(
									"device").getLength() > 0) {
								NodeList deviceLst = ((Element) tbnode)
								...
								if (devicenr > 0) {
									for (int i = 0; i < devicenr; i++) {
										...
										DefaultMutableTreeNode child6 = new DefaultMutableTreeNode(
												"Family: " + d.family, false);
										child.add(child6);
										try {
											d.setModel(((Element) node)
													.getElementsByTagName(
															"devicemodel")
													.item(0).getChildNodes()
													.item(0).getNodeValue());
										...
										DefaultMutableTreeNode child7 = new DefaultMutableTreeNode(
												"Model: " + d.model, false);
										child.add(child7);
										if (((Element) node).getChildNodes()
												.getLength() > 15) {
											for (int k = 15; k < ((Element) node)
													.getChildNodes()
													.getLength(); k++) {
												if (((Element) node)
														.getChildNodes()
										...
										if (((Element) node)
												.getElementsByTagName(
														"devicemodule")
												.getLength() > 0) {
											NodeList listamodule = ((Element) node)
													.getElementsByTagName("devicemodule");
											for (int k = 0; k < listamodule
													.getLength(); k++) {
														...
														dmodul.properties
																.add(new String[] {
																		...
																		((Element) modul)
																				...
																				.item(0)
																				.getNodeValue() });
														DefaultMutableTreeNode child10 = new DefaultMutableTreeNode(
																((Element) modul)
																		.getChildNodes()
																		.item(l)
																		.getNodeName()
												...
												if (((Element) modul)
														.getElementsByTagName(
																"deviceport")
														.getLength() > 0) {
													NodeList listaporturi = ((Element) modul)
															.getElementsByTagName("deviceport");
													for (int l = 0; l < listaporturi
															.getLength(); l++) {
														Node port = listaporturi
																.item(l);
														DevicePort dport = null;
														try {
															dport = new DevicePort(
																	((Element) port)
																			.getElementsByTagName(
																					"port")
																			.item(0)
														...
														DefaultMutableTreeNode child13 = new DefaultMutableTreeNode(
																...
																false);
														child11.add(child13);
														for (int m = 5; m < ((Element) port)
																.getChildNodes()
																.getLength(); m++) {
															Node prop = ((Element) port)
																	.getChildNodes()
																	.item(m);
															dport.properties
																	.add(new String[] {
																			...
																			((Element) prop)
																					...
																					.item(0)
																					.getNodeValue() });
															DefaultMutableTreeNode child14 = new DefaultMutableTreeNode(
																	((Element) prop)
																			.getNodeName()
																			+ " - "
																			+ ((Element) prop)
	...
	public void traverseTree(TreeNode t, Element root, Document document) {
		...
		if (((DefaultMutableTreeNode) t).getUserObject() instanceof DeviceModule) {
			...
			if (root.getNodeName().equals("testbed")) {
				if (((String) ((DefaultMutableTreeNode) t).getUserObject())
						.indexOf("Id: ") != -1) {
					Element em = addElement(document, t, root, "testbedid",
							"Id: ", 1);
					Element em2 = document.createElement("testbedname");
					try {
						em2.appendChild(document
								.createTextNode(((DefaultMutableTreeNode) ((DefaultMutableTreeNode) t)
										.getParent()).getUserObject()
										.toString().split("TestBed: ")[1]));
					} catch (Exception e) {
						em.appendChild(document.createTextNode(""));
					}
					root.appendChild(em2);
				} else if (((String) ((DefaultMutableTreeNode) t)
						.getUserObject()).indexOf("Description: ") != -1) {
					addElement(document, t, root, "testbeddesc",
							"Description: ", 1);
				}
			}
			if (root.getNodeName().equals("device")) {
				if (((String) ((DefaultMutableTreeNode) t).getUserObject())
						.indexOf("Id: ") != -1) {
					Element em = addElement(document, t, root, "deviceid",
							"Id: ", 1);
			...
			if (root.getNodeName().equals("deviceport")) {
				if (((String) ((DefaultMutableTreeNode) t).getUserObject())
					...
					try {
						em.appendChild(document
								.createTextNode(((String) ((DefaultMutableTreeNode) t)
										.getUserObject()).split("Port type: ")[1]));
					} catch (Exception e) {
						em.appendChild(document.createTextNode(""));
					}
					root.appendChild(em);
	...
	public Element addElement(Document document, TreeNode t, Element root,
			String tag, String split, int index) {
		Element em = document.createElement(tag);
		try {
			em.appendChild(document
					.createTextNode(((String) ((DefaultMutableTreeNode) t)
							.getUserObject()).split(split)[index]));
		} catch (Exception e) {
			em.appendChild(document.createTextNode(""));
		}
		root.appendChild(em);
	...
	public void getProp(TreeNode t, Document document, Element root) {
		String name = "";
		try {
			name = ((String) ((DefaultMutableTreeNode) t).getUserObject())
					.split(" - ")[0];
		} catch (Exception e) {
			name = "null";
		}
		String value = "";
		try {
			value = ((String) ((DefaultMutableTreeNode) t).getUserObject())
					.split(" - ")[1];
		} catch (Exception e) {
			value = "null";
		}
