...
public class DUT extends JPanel{
    int x1,y1;
    JPanel config,p2,propertys,propertys2,propertys3,p3,p4;;
    Device temp;
    DeviceModule temp2; 
    DevicePort temp3; 
    ...
    public DUT(){
        ...
        p4 = new JPanel();
        p4.setLayout(null);
        p4.setBounds(640,5,400,650);
        JLabel PropName3 = new JLabel("Prop. Name");
        JLabel PropValue3 = new JLabel("Prop. Value");
        PropName3.setBounds(15,55,100,25);
        PropValue3.setBounds(120,55,100,25);
        p4.add(PropName3);
        p4.add(PropValue3);
        propname3 = new JTextField();
        propname3.setBounds(10,75,150,25);
        p4.add(propname3);
        propvalue3 = new JTextField();
        propvalue3.setBounds(165,75,160,25);
        p4.add(propvalue3);
        ...
        p3 = new JPanel();
        p3.setLayout(null);
        p3.setBounds(640,5,400,650);
        JLabel PropName2 = new JLabel("Prop. Name");
        JLabel PropValue2 = new JLabel("Prop. Value");
        PropName2.setBounds(15,35,100,25);
        PropValue2.setBounds(120,35,100,25);
        p3.add(PropName2);
        p3.add(PropValue2);
        propname2 = new JTextField();
        propname2.setBounds(10,65,150,25);
        p3.add(propname2);
        propvalue2 = new JTextField();
        propvalue2.setBounds(165,65,160,25);
        p3.add(propvalue2);
        ...
        tname2.addKeyListener(new KeyAdapter(){
            public void keyReleased(KeyEvent ev){
                if(temp2!=null){
                    ...
                    ((DefaultMutableTreeNode)nodetemp2.getChildAt(0)).setUserObject("Name: "+tname2.getText());
        ...
        p2 = new JPanel();
        p2.setLayout(null);
        p2.setBounds(640,5,400,650);
        config.setLayout(null);
        config.setPreferredSize(new Dimension(1070,680));
        config.setBorder(BorderFactory.createBevelBorder(BevelBorder.LOWERED));        
        propertys = new JPanel();
        propertys.setLayout(null);
        JScrollPane scrollPane2 = new JScrollPane(propertys);
        scrollPane2.setBounds(3,17,382,360);
        scrollPane2.setBorder(null);
        JPanel fpropertys = new JPanel();
        fpropertys.setLayout(null);
        fpropertys.setBorder(BorderFactory.createTitledBorder("Properties"));
        fpropertys.setBounds(2,255,388,380);
        fpropertys.add(scrollPane2);
        p2.add(fpropertys);
        ...
        PropName.setBounds(15,205,150,25);
        PropValue.setBounds(170,205,150,25);
        p2.add(PropName);
        p2.add(PropValue);
        propname = new JTextField();
        propname.setBounds(10,230,150,25);
        p2.add(propname);
        propvalue = new JTextField();
        propvalue.setBounds(165,230,160,25);
        p2.add(propvalue);
        ...
        load.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ev){            
                try{
                    ...
                    String config = (String)JOptionPane.showInputDialog(null, "Please select a DUT file", "Config", 1, null, configs, "Configs");
                    if(config!=null){
                                ...
                                for(int i = 0;i<childsnr;i++){
                                    ...
                                    if(((Element)node).getElementsByTagName("devicemodule").getLength()>0){
                                        ...
                                        for(int k=0;k<listamodule.getLength();k++){
                                            ...
                                            child.add(child8);
                                            DefaultMutableTreeNode child9 = new DefaultMutableTreeNode("Name: "+dmodul.name,false);
                                            child8.add(child9);
                                            Node modul = listamodule.item(k);
                                            for(int l=1;l<((Element)modul).getChildNodes().getLength();l++){
                                                if(((Element)modul).getChildNodes().item(l).getNodeName().equals("deviceport"))break;
                                                dmodul.propertys.add(new String[]{((Element)modul).getChildNodes().item(l).getNodeName(),((Element)modul).getChildNodes().item(l).getChildNodes().item(0).getNodeValue()});
                                            ...
                                            if(((Element)modul).getElementsByTagName("deviceport").getLength()>0){
                                                ...
                                                for(int l=0;l<listaporturi.getLength();l++){
                                                    ...
                                                    DevicePort dport = new DevicePort(((Element)port).getElementsByTagName("port").item(0).getChildNodes().item(0).getNodeValue(),((Element)port).getElementsByTagName("portType").item(0).getChildNodes().item(0).getNodeValue());
        ...
        generate.setBounds(838,648,90,24);
        generate.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ev){
                try{String status="";
                    try{status = (String)Repository.f.p.p2.client.execute("getExecStatusAll",new Object[]{});}
        ...
        if(((DefaultMutableTreeNode)t).getUserObject() instanceof DeviceModule){
            ...
            if(root.getNodeName().equals("device")){
                if(((String)((DefaultMutableTreeNode)t).getUserObject()).indexOf("Id: ")!=-1){
                    Element em = document.createElement("deviceid");
                    try{em.appendChild(document.createTextNode(((String)((DefaultMutableTreeNode)t).getUserObject()).split("Id: ")[1]));}
                    catch(Exception e){em.appendChild(document.createTextNode(""));}
                    root.appendChild(em);
                    Element em2 = document.createElement("devicename");                    
                    try{em2.appendChild(document.createTextNode(((DefaultMutableTreeNode)((DefaultMutableTreeNode)t).getParent()).getUserObject().toString()));}
                    catch(Exception e){em.appendChild(document.createTextNode(""));}
                    root.appendChild(em2);}
                else if(((String)((DefaultMutableTreeNode)t).getUserObject()).indexOf("Description: ")!=-1){
                    Element em = document.createElement("devicedesc");
                    try{em.appendChild(document.createTextNode(((String)((DefaultMutableTreeNode)t).getUserObject()).split("Description: ")[1]));}
                    catch(Exception e){em.appendChild(document.createTextNode(""));}
                    root.appendChild(em);}
                else if(((String)((DefaultMutableTreeNode)t).getUserObject()).indexOf("Vendor: ")!=-1){
                    Element em = document.createElement("devicevendor");
                    try{em.appendChild(document.createTextNode(((String)((DefaultMutableTreeNode)t).getUserObject()).split("Vendor: ")[1]));}
                    catch(Exception e){em.appendChild(document.createTextNode(""));}
                    root.appendChild(em);}
                else if(((String)((DefaultMutableTreeNode)t).getUserObject()).indexOf("Type: ")!=-1){
                    Element em = document.createElement("devicetype");
                    try{em.appendChild(document.createTextNode(((String)((DefaultMutableTreeNode)t).getUserObject()).split("Type: ")[1]));}
                    catch(Exception e){em.appendChild(document.createTextNode(""));}
                    root.appendChild(em);}
                else if(((String)((DefaultMutableTreeNode)t).getUserObject()).indexOf("Family: ")!=-1){
                    Element em = document.createElement("devicefamily");
                    try{em.appendChild(document.createTextNode(((String)((DefaultMutableTreeNode)t).getUserObject()).split("Family: ")[1]));}
                    catch(Exception e){em.appendChild(document.createTextNode(""));}
                    root.appendChild(em);}
                else if(((String)((DefaultMutableTreeNode)t).getUserObject()).indexOf("Model: ")!=-1){
                    Element em = document.createElement("devicemodel");
                    try{em.appendChild(document.createTextNode(((String)((DefaultMutableTreeNode)t).getUserObject()).split("Model: ")[1]));}
                    catch(Exception e){em.appendChild(document.createTextNode(""));}
                    root.appendChild(em);}
                else{Element em = document.createElement(((String)((DefaultMutableTreeNode)t).getUserObject()).split(" - ")[0]);
                    try{em.appendChild(document.createTextNode(((String)((DefaultMutableTreeNode)t).getUserObject()).split(" - ")[1]));}
                    catch(Exception e){em.appendChild(document.createTextNode(""));}
                    root.appendChild(em);}}
            if(root.getNodeName().equals("devicemodule")){
                if(((String)((DefaultMutableTreeNode)t).getUserObject()).indexOf("Name: ")!=-1){}
                else{Element em;
                    try{em = document.createElement(((String)((DefaultMutableTreeNode)t).getUserObject()).split(" - ")[0]);}
                    catch(Exception e){em = document.createElement("");}
                    try{em.appendChild(document.createTextNode(((String)((DefaultMutableTreeNode)t).getUserObject()).split(" - ")[1]));}
                    catch(Exception e){em.appendChild(document.createTextNode(""));}
                    root.appendChild(em);}}
            if(root.getNodeName().equals("deviceport")){                
                if(((String)((DefaultMutableTreeNode)t).getUserObject()).indexOf("Port type: ")!=-1){
                    ...
                    Element em = document.createElement(((String)((DefaultMutableTreeNode)t).getUserObject()).split(" - ")[0]);
                    try{em.appendChild(document.createTextNode(((String)((DefaultMutableTreeNode)t).getUserObject()).split(" - ")[1]));}
                    catch(Exception e){em.appendChild(document.createTextNode(""));}
                    root.appendChild(em);}}}
