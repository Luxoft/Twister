...
public class DeviceModule {
	...
	public void updatePropertys() {
		...
		if (Repository.window.mainpanel.p4.getDut().nodetemp2.getChildAt(
				Repository.window.mainpanel.p4.getDut().nodetemp2
						.getChildCount() - 1).isLeaf()) {
			while (Repository.window.mainpanel.p4.getDut().nodetemp2
					.getChildCount() > 1) {
		...
		for (int i = 0; i < properties.size(); i++) {
			...
			b.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent ev) {
					properties.remove(Repository.window.mainpanel.p4.getDut().properties2
			...
			text1.addKeyListener(new KeyAdapter() {
				...
				public void keyReleased(KeyEvent ev) {
					properties.get(Repository.window.mainpanel.p4.getDut().properties2
		...
		Repository.window.mainpanel.p4.getDut().properties2
				.setPreferredSize(new Dimension(Repository.window.mainpanel.p4
						.getDut().properties2.getWidth(),
