...
public class ConfigFiles extends JPanel{
    ...
    private static JTextField ttcpath,tMasterXML,tUsers,tepid,tlog,trunning,tname,thardwareconfig,tdebug,tsummary,tinfo,tcli,tdbfile,temailfile,tceport,traPort,thttpPort;
    JPanel paths;
                        ...
                        if(doc!=null){
                            ...
                            if(nodeLst.getLength()>0){
                                ...
                                if(fstNm.item(0).getNodeValue().toString().equals("config")){
                                    ...
                                    Repository.frame.mainpanel.p2 = new Panel2(Repository.applet);
                                    Repository.frame.mainpanel.setComponentAt(1, Repository.frame.mainpanel.p2);
                                    Repository.frame.mainpanel.p1.ep.refreshStructure();
                                    Repository.frame.mainpanel.p4.dbconfig.refresh();
