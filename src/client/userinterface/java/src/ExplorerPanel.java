...
public class ExplorerPanel extends JPanel {
			...
			item.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent evnt) {
					try {
						...
						System.out
								.println("There was an error in opening editors configuration window, please check configuration file");
						e.printStackTrace();
					}
				}
			});
	...
	/*
	 * Propmpts user to select editor and opens selected editor for editing TC
	 */
