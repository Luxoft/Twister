...
/*
 * custom dialog class to implement always on top
 *
 */
public class CustomDialog {
	...
	public static String showButtons(Component parent, int messagetype,
			int optiontype, Icon icon, Object[] options, String title,
			String message) {
	 ...
	 */
	public static String showInputDialog(int type, int options,
			Component parent, String title, String text) {
	 ...
	 * used to show info
	 */
	public static void showInfo(int type, Component parent, String title,
			String text) {
		JLabel label = new JLabel(text);
