...
public class DBConfig extends JPanel{
        ...
        upload.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ev){
                ...
                try{File f = new File(tfile.getText());
                    ...
                    RunnerRepository.uploadRemoteFile(RunnerRepository.REMOTEDATABASECONFIGPATH, stream, f.getName(),false);
                ...
                if(doc!=null){
                    ...
                    try{theone = new File(RunnerRepository.temp+RunnerRepository.getBar()+"Twister"+
                        ...
                        try{DOMSource source = new DOMSource(doc);
                            ...
                            RunnerRepository.uploadRemoteFile(RunnerRepository.REMOTEDATABASECONFIGPATH, input, theone.getName(),false);
                        }
                        catch(Exception e){
                            saved = false;
                            e.printStackTrace();
    ...
    private void refresh(){
        try{
            ...
            String content = new String(RunnerRepository.getRemoteFileContent(RunnerRepository.REMOTEDATABASECONFIGPATH+RunnerRepository.REMOTEDATABASECONFIGFILE,false));
